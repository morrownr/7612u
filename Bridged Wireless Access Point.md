...
#
# The below line is required for 80 MHz width channel operation
# but it is currently causing serious problems on my test setup
# so it remains inactive. This limits capability to 40 MHz channel
# width and 400 Mb/s.
#
# Your setup may work so feel free to give it a try.
#
#vht_oper_chwidth=1
#
# if channel 36 is used, must be active if the above line is active
#vht_oper_centr_freq_seg0_idx=42
#
# if channel 149 is used, must be active if the above line is active
